...
-- This SQL script populates the PolicyTypes table with different types of insurance policies and their descriptions.
INSERT INTO Policy_Types (PolicyTypeName, Description) VALUES
...
-- This SQL script populates the Customers table with sample customer data, including personal information and contact details.
...
-- This SQL script populates the Policies table with sample policy data, linking it to the customers and policy types.
...
-- This SQL script populates the Claims table with sample claim data, linking it to the policies and including various claim scenarios.
